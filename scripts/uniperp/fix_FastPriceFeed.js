...
async function main() {
  ...
  await sendTxn(secondaryPriceFeed.setVaultPriceFeed(ethers.constants.AddressZero), "secondaryPriceFeed.setVaultPriceFeed zero")
  await sendTxn(secondaryPriceFeed.setVaultPriceFeed(vaultPriceFeed.address), "secondaryPriceFeed.setVaultPriceFeed true")
