...
async function main() {
  ...
  const timelock = await contractAt("Timelock", "0x8E66C9da3dE244311E382A4Ea835c36914E5A39a")

  await sendTxn(timelock.setTokenConfig(vault.address,
    "0x3af56d8dcc9a2765344b5570bf78E66653458831",
    0,
    0,
    0,
    0,
    0), "timelock.setTokenConfig");
  ...
  await sendTxn(timelock.setTokenConfig(vault.address,
            "0xd7f6cc1f6D1716b33DB6e18179AdF1C379263AE7",
            0,
            0,
            0,
            0,
