...
async function getArbValues() {
  ...
  return { vault, tokenManager, ulpManager, rewardRouter, positionRouter, positionManager, unip }
}
...
async function getAvaxValues() {
  ...
  const unip = { address: "0x62edc0692BD897D2295872a9FFCac5425011c661" }
...
async function main() {
  ...
  const { vault, tokenManager, ulpManager, rewardRouter, positionRouter, positionManager, unip } = await getValues()
  ...
  await sendTxn(deployedTimelock.signalApprove(unip.address, admin, "1000000000000000000"), "deployedTimelock.signalApprove")
}
